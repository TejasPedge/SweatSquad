    ...
    return (
        <div className='mb-[10%]' id="successfull">
            ...
            <div className='grid grid-cols-3 gap-10 w-[80%] m-auto'>
                <div className='text-[#666679] '>
                    <div className='overflow-hidden'><img src={transformation2} alt="transformation2" className='rounded-[20px] h-[300px] transform hover:scale-125 transition duration-500' /></div>
                ...
                <div className='text-[#666679] '>
                    <div className='overflow-hidden'><img src={transformation3} alt="transformation2" className='rounded-[20px] h-[300px] transform hover:scale-125 transition duration-500' /></div>
                ...
                <div className='text-[#666679] '>
                    <div className='overflow-hidden' ><img src={transformation4} alt="transformation2" className='rounded-[20px]  h-[300px] transform hover:scale-125 transition duration-500 ' /></div>
